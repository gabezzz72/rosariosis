...
{
	// @todo Use AllowEditTeacher() since RosarioSIS 12.4
...
if ( ! $_REQUEST['modfunc'] )
{
	...
	echo '<a href="#!" class="onclick-lesson-plan-add-item">' . button(
		'add',
	 ...
	 */
	?>
	<script src="modules/Lesson_Plan/js/AddLesson.js?v=1.2"></script>
	<?php
